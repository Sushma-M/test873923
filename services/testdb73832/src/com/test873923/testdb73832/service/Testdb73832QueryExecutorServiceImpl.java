...
@Service
public class Testdb73832QueryExecutorServiceImpl implements Testdb73832QueryExecutorService {
	private static final Logger LOGGER = LoggerFactory.getLogger(Testdb73832QueryExecutorServiceImpl.class);

	@Autowired
	@Qualifier("testdb73832WMQueryExecutor")
