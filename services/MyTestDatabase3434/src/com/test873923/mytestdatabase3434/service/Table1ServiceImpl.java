 ...
 */
@Service("MyTestDatabase3434.Table1Service")
public class Table1ServiceImpl implements Table1Service {
    ...
    @Autowired
    @Qualifier("MyTestDatabase3434.Table1Dao")
    ...
    public void setWMGenericDao(WMGenericDao<Table1, Integer> wmGenericDao){
     ...
     @Transactional(readOnly = true, value = "MyTestDatabase3434TransactionManager")
    ...
    @Transactional(rollbackFor = EntityNotFoundException.class, value = "MyTestDatabase3434TransactionManager")
    @Override
