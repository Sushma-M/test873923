...
import com.test873923.mytestdatabase3434.service.Table1Service;
...
import com.test873923.mytestdatabase3434.*;
import com.test873923.mytestdatabase3434.service.*;


/**
 * Controller object for domain model class Table1.
 * @see com.test873923.mytestdatabase3434.Table1
 */

@RestController(value = "MyTestDatabase3434.Table1Controller")
@Api(value = "/MyTestDatabase3434/Table1", description = "Exposes APIs to work with Table1 resource.")
@RequestMapping("/MyTestDatabase3434/Table1")
public class Table1Controller {

    private static final Logger LOGGER = LoggerFactory.getLogger(Table1Controller.class);

	@Autowired
	@Qualifier("MyTestDatabase3434.Table1Service")
